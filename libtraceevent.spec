...
Version  : 1.6.0
Release  : 12
URL      : https://git.kernel.org/pub/scm/libs/libtrace/libtraceevent.git/snapshot/libtraceevent-1.6.0.tar.gz
Source0  : https://git.kernel.org/pub/scm/libs/libtrace/libtraceevent.git/snapshot/libtraceevent-1.6.0.tar.gz
...
%prep
%setup -q -n libtraceevent-1.6.0
cd %{_builddir}/libtraceevent-1.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653332690
...
/usr/lib64/libtraceevent.so.1.6.0
