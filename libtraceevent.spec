...
Source0  : https://git.kernel.org/pub/scm/libs/libtrace/libtraceevent.git/snapshot/libtraceevent-1.6.4.tar.gz
...
%prep
%setup -q -n libtraceevent-1.6.4
cd %{_builddir}/libtraceevent-1.6.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670872449
...
/usr/lib64/libtraceevent.so.1.6.4
