...
Source0  : https://git.kernel.org/pub/scm/libs/libtrace/libtraceevent.git/snapshot/libtraceevent-1.6.2.tar.gz
...
%prep
%setup -q -n libtraceevent-1.6.2
cd %{_builddir}/libtraceevent-1.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657839791
...
/usr/lib64/libtraceevent.so.1.6.2
