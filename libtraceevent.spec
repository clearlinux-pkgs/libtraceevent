...
Source0  : https://git.kernel.org/pub/scm/libs/libtrace/libtraceevent.git/snapshot/libtraceevent-1.5.0.tar.gz
...
%prep
%setup -q -n libtraceevent-1.5.0
cd %{_builddir}/libtraceevent-1.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645057970
...
/usr/lib64/libtraceevent.so.1.5.0
