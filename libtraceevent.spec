...
Version  : 1.5.1
Release  : 9
URL      : https://git.kernel.org/pub/scm/libs/libtrace/libtraceevent.git/snapshot/libtraceevent-1.5.1.tar.gz
Source0  : https://git.kernel.org/pub/scm/libs/libtrace/libtraceevent.git/snapshot/libtraceevent-1.5.1.tar.gz
...
%prep
%setup -q -n libtraceevent-1.5.1
cd %{_builddir}/libtraceevent-1.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645567014
...
/usr/lib64/libtraceevent.so.1.5.1
