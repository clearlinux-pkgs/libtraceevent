...
Source0  : https://git.kernel.org/pub/scm/libs/libtrace/libtraceevent.git/snapshot/libtraceevent-1.4.0.tar.gz
...
%prep
%setup -q -n libtraceevent-1.4.0
cd %{_builddir}/libtraceevent-1.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631288233
...
/usr/lib64/libtraceevent.so.1.4.0
