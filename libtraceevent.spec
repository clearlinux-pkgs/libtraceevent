...
Source0  : https://git.kernel.org/pub/scm/libs/libtrace/libtraceevent.git/snapshot/libtraceevent-1.5.2.tar.gz
...
%prep
%setup -q -n libtraceevent-1.5.2
cd %{_builddir}/libtraceevent-1.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646936415
...
/usr/lib64/libtraceevent.so.1.5.2
