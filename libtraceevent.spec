...
Source0  : https://git.kernel.org/pub/scm/libs/libtrace/libtraceevent.git/snapshot/libtraceevent-1.5.3.tar.gz
...
%prep
%setup -q -n libtraceevent-1.5.3
cd %{_builddir}/libtraceevent-1.5.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648229566
